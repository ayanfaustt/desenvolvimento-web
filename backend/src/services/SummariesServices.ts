...
class SummariesServices {
  ...
  private systemResponseSamplePrompt =
    "{ 'tema': 'O que é o modelo OSI', 'resumo': 'O modelo OSI é um padrão de arquitetura de redes que define como os computadores se comunicam em rede.'}";
